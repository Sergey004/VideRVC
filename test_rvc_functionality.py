...
def run_rvc_test():
    ...
    rvc_model_path = "models\RVC\Glamrock_Freddy\Glamrock_Freddy_RU_50e_2000s.pth"  # e.g., "./models/your_model.pth"
    audio_input_path = "Record 2025-08-30 at 14h43m05s.wav"  # e.g., "./test_audio.wav"
    f0_method = "crepe"  # or "rmvpe"
    pitch_shift = 0
    index_rate = 0.5
    index_path = "models\RVC\Glamrock_Freddy\added_IVF1428_Flat_nprobe_1_v2.index"  # set path to .index if available, else leave empty
